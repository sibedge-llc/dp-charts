...
helm uninstall schema-registry --namespace schema-registry 
...
docker run --rm -p 8000:8000 -e "SCHEMAREGISTRY_URL=http://localhost:50450" landoop/schema-registry-ui
